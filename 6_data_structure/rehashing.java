...
Notice: For negative integer in hash table, the position can be calculated as follow:
1 C++/Java: if you directly calculate -4 % 3 you will get -1. 
  You can use function: a % b = (a % b + b) % b to make it is a non negative integer.
2 Python: you can directly use -1 % 3, you will get 2 automatically.
